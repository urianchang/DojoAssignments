...
SELECT sites.domain_name, leads.first_name, leads.last_name FROM sites 
...
SELECT clients.first_name AS client_first, clients.last_name, sites.domain_name, leads.first_name AS leads_first FROM clients
